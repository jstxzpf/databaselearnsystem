...
数据库学习系统是一个基于Flask和Ollama AI的现代化Web学习平台，专为辅助学生学习数据库课程设计。系统采用响应式设计，支持跨平台访问，集成了知识学习、考试生成和试卷审批三大功能，通过本地AI模型提供智能辅导。
...
- **AI服务**: Ollama本地API
- **数据存储**: JSON知识库 + SQLite用户数据

## 系统要求

- Python 3.8+
- 本地运行的Ollama服务（支持chat API）
- 推荐使用gemma2:27b模型（或其他兼容模型）
